*     Header     *
* Modified on 03/03/2023 to accommodate the PWL models*
...
*$batInclude C:\GAMS\35\gamslib_ml\pwlfunc.inc BidPwl s x y l g ESR
...
*PUMP_EFFICIENCY(STORAGE_GEN,INTERVAL) =E= 0.0106*CONVENTIONAL_PUMP_SCHEDULE(STORAGE_GEN,INTERVAL)*100-0.0068
...
*Need an extra equation to calculate the available capacity of nuclear plant
